import{_ as s,o as a,c as e,Q as n}from"./chunks/framework.df6e7049.js";const g=JSON.parse('{"title":"删除所有 Commit 提交记录","description":"","frontmatter":{},"headers":[],"relativePath":"Web/Git/Git1/g1.md","filePath":"Web/Git/Git1/g1.md"}'),t={name:"Web/Git/Git1/g1.md"},l=n(`<h1 id="删除所有-commit-提交记录" tabindex="-1">删除所有 Commit 提交记录 <a class="header-anchor" href="#删除所有-commit-提交记录" aria-label="Permalink to &quot;删除所有 Commit 提交记录&quot;">​</a></h1><ul><li>创建新分支，并切换到该分支</li><li>暂存所有文件</li><li>提交所有更改</li><li>删除主分支 master</li><li>重命名当前分支为 master</li><li>强制推送本地分支</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">git checkout --orphan latest_branch</span></span>
